<template>
  <div class="side">
    <div class="d-flex justify-left">
      ...
      <v-btn density="compact" icon="mdi-pencil" @click="toggleEdit"></v-btn>
    </div>
    <!-- 父关系 -->
    <Relations :edit="edit" :relations="parents" :relations_type="'parents'" class="relation-item" />
    ...
    <Relations :edit="edit" :relations="children" :relations_type="'children'" class="relation-item" />
  </div>
</template>
